...
public class AICommander_Victory : AICommanderWithObjective, IXmlSerializable
{
	...
	public override void PopulateMission()
	{
		...
		else if (this.questManagementService.IsQuestRunningForEmpire("VictoryQuest-Chapter5Alt2", base.Empire))
		{
			this.ActiveVictoryQuest = "VictoryQuest-Chapter5Alt2";
			this.VictoryDesign = "MimicsUnit2";
			this.questBehaviour = this.questRepositoryService.GetQuestBehaviour("VictoryQuest-Chapter5", base.Empire.Index);
		}
		...
		{
			if (!this.ActiveVictoryQuest.Contains("VictoryQuest-Chapter5"))
			{
