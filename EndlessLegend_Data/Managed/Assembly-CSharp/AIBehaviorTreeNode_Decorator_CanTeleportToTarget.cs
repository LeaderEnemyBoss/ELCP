...
public class AIBehaviorTreeNode_Decorator_CanTeleportToTarget : AIBehaviorTreeNode_Decorator
{
	...
	protected override State Execute(AIBehaviorTree aiBehaviorTree, params object[] parameters)
	{
		...
		if (!army.Empire.SimulationObject.Tags.Contains("FactionTraitAffinityStrategic") || !army.Empire.SimulationObject.Tags.Contains("BoosterTeleport") || army.HasSeafaringUnits() || army.GetPropertyValue(SimulationProperties.Movement) < 0.1f || army.IsSolitary)
		{
			return State.Failure;
		}
