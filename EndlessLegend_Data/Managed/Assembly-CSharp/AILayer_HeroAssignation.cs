...
public class AILayer_HeroAssignation : AILayer, ITickable, ISimulationAIEvaluationHelper<UnitSkill>, IAIEvaluationHelper<UnitSkill, InterpreterContext>
{
	...
	{
		AILayer_HeroAssignation.<GenerateAllPossibleAssignation>c__AnonStorey80D <GenerateAllPossibleAssignation>c__AnonStorey80D = new AILayer_HeroAssignation.<GenerateAllPossibleAssignation>c__AnonStorey80D();
		<GenerateAllPossibleAssignation>c__AnonStorey80D.<>f__this = this;
		...
		<GenerateAllPossibleAssignation>c__AnonStorey80D.nonInfectedCities = this.departmentOfTheInterior.NonInfectedCities;
		int index2;
		for (index2 = 0; index2 < <GenerateAllPossibleAssignation>c__AnonStorey80D.nonInfectedCities.Count; index2++)
		{
			if (!this.assignationData.Exists((AssignationData match) => match.Garrison == <GenerateAllPossibleAssignation>c__AnonStorey80D.nonInfectedCities[index2]))
			{
				this.assignationData.Add(new AssignationData_City(<GenerateAllPossibleAssignation>c__AnonStorey80D.nonInfectedCities[index2]));
			}
		}
		int index;
