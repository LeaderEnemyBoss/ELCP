...
public class AIBehaviorTreeNode_Decorator : BehaviourTreeNode
{
	...
	protected virtual State Execute(AIBehaviorTree behaviorTree, params object[] parameters)
	{
		return State.Success;
	}

	protected virtual bool Initialize(AIBehaviorTree questBehaviour)
	{
		return true;
	}
}
